...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Loại sản phẩm</label>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Kích cỡ</label>
            </div>
            ...
            <div class="form-group">
              <div class="d-flex justify-content-end w-100">
                <button class="btn btn-flat bg-light border" type="button" id="add_size"><i class="fa fa-plus"></i>Thêm kích cỡ</button>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Màu sắc</label>
            </div>
            <?php if(isset($id) && $id > 0): ?>
            <?php 
            ...
            <div class="form-group">
              <div class="d-flex justify-content-end w-100">
                <button class="btn btn-flat bg-light border" type="button" id="add_color"><i class="fa fa-plus"></i>Thêm màu sắc</button>
              </div>
            </div>
          </div>
        </div>
