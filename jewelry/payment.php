...
<div class="tab_container">
     ...
     <label for="tab4"><span class="numberCircle">0</span><span>Thanh toán</span></label>

     <section id="content4" class="tab-content">
          <h4 class="payment-title">Lựa chọn giao thức thanh toán</h4>
          <form action="" method="post">
               ...
               <div class="form-cc">
                    <div class="row-cc">
                         <div class="cc-field">
                              <div class="cc-title">Số thẻ tín dụng
                              </div>
                    ...
                    <div class="row-cc">
                         <div class="cc-field">
                              <div class="cc-title">Tên trên thẻ
                              </div>
                              <input type="text" class="input cc-txt" />
                         </div>
                    </div>
